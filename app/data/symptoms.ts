...
const symptomsList = [
  ...
  },
  {
    ...
    tags: ["swollen", "puffy"],
    location: ["facial", "periorbital", "hands", "lower-limbs", "abdomen"],
    duration: [],
    onset: ["gradual"],
    nature: ["progressive-decrease-during-day"],
    periodicity: ["early-morning", "non-specific", "intermittent"],
    aggravators: ["increased-fluid-intake", "laying-down"],
    relievers: [],
  },
  {
    symptom: "foamy-urine",
  ...
  },
  {
    ...
    description:
      "An abnormal lump, bump, ulcer, sore, or colored area of the skin - an area of abnormal tissue.",
...
export const getSymptomByName =
  ...
  (name: string): SymptomItem => {
    return symptoms.find(
      (symptom) => symptom.symptom?.toLowerCase() === name?.toLowerCase()
    );
  };
